				...
				<div class="contact">
						<div class="row" style="margin-top:2rem;">
							<div class="form-group col-md-12" >
								<input type="text" name="name" class="form-control" placeholder="여행사 명" required="required" v-model="agencyName">
							</div>
    ...
    export default {
      ...
      methods: {
            ...
            async regAgency(){
                ...
                if(this.$emptyChk(this.roadAddress)){
                    this.$swal('','여행사 명을 입력해주세요.','warning');
                    return;
                }
                ...
                let param = {
                    ...
                    "file_id" : this.saveThumbnail_id,
                    "comment" : this.agencyComment
                }
                await this.$axios.post(process.env.VUE_APP_TRAVEL_AGENCY_INSERT ,param,{headers}).then((res) =>{
